...
output:
  ...
  pdf_document:
    toc: yes
    toc_depth: '3'
subtitle: "African Institute for Mathematical Sciences - National Institute of Statistics
  of Rwanda"
---
...
1. Choose your OS (operating system): 
  ...
  * and for Linux [Debian, Fedora/Redhat, Ubuntu](https://cloud.r-project.org/bin/linux/)
2. Install Rstudio:
